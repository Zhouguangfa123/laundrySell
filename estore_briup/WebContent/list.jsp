        ...
        <div class="c4_b2">
            <h1 class="c4_b2_x">
            	<c:if test="${!empty category.parent}">
	            	<a href="toBookCategory.do?mark=1&categoryId=${category.parent.categoryId}">${category.parent.name }&nbsp;&nbsp;></a>
	                <span><a href="toBookCategory.do?mark=2&categoryId=${category.categoryId}">${category.name }</a></span>
                </c:if>
                <c:if test="${empty category.parent}">
	            	<a href="toBookCategory.do?mark=1&categoryId=${category.categoryId}">${category.name }&nbsp;&nbsp;</a>
                </c:if>
            </h1> 
                	...
                	<li class="c4_b5_c_box">
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="viewBook.do?bookId=${book.bookId }""><img src="images/list_p1.png"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>￥ ${book.price }</h1>
                            <h2><a href="viewBook.do?bookId=${book.bookId }">${book.name }</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
                        ...
                        <ul class="c4b5_option">
                                <li class="shopcar_box"><span class="shopcar01"></span><a href="user/addShopCar.do?bookId=${book.bookId }&num=1">加入购物车</a></li>
                        </ul>
                    </li>
            	</c:forEach>
                    <!-- <li class="c4_b5_c_box">
