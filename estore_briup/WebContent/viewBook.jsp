...
<body>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="toIndex.do"><img src="images/logo.png"></a>
    	<div class="h3_center">
	...
	<div class="container5">
    	<div class="cn5_top">
            <div class="cn5_top_x center01">
            	<a class="font20" href="toBookCategory.do?mark=1&categoryId=${viewbook.category.parent.categoryId}">${viewbook.category.parent.name }&nbsp;&nbsp;</a> >
                <a href="toBookCategory.do?mark=2&categoryId=${viewbook.category.categoryId}">${viewbook.category.name }</a>
            </div>
            <div class="cn5_top_y center01">
                ...
                <div class="cn5topy_2">
                    <!-- <div>
	                	...
	                	<h1 class="pro_title font15">${viewbook.name }</h1>
	                    <div class="pro_price">
	                            <div class="pro_price_x">
	                                <p> briup价：<b>￥${viewbook.price }</b> <a href="#">(降价通知)</a></p>
	                            </div>
	                    ...
	                    <div class="pro_selects">
	                        ...
	                        <div class="pro_select">
	                            ...
	                            <ul class="pro_select_vals">
	                                <li> 出版时间:<fmt:formatDate value="${viewbook.pubDate }" pattern="yyyy-MM-dd"/></li>
	                                <li>包装：平装</li>
	                                <li>正文语种：中文</li>
	                            </ul>
	                        </div>
        ...
        <form action="user/addShopCar.do" id="addCar">
        <input type="hidden" name="bookId" value="${viewbook.bookId }" />
             <div class="pro_buy">
